...
The optimized capture and monitor sources were reconstructed, built and smoke-tested in CI before their clean source commit was published. Temporary transport files and the self-cleaning workflow are absent from the resulting branch.
