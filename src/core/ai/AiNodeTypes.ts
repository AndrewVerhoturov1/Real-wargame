import {
  DEFAULT_AI_NODE_CONTRACT_REGISTRY,
} from './contracts/AiNodeContractRegistry';
...
export const AI_NODE_TYPE_DEFINITIONS = Object.fromEntries(
  DEFAULT_AI_NODE_CONTRACT_REGISTRY.list().map((contract) => [contract.type, {
    type: contract.type,
    category: contract.category,
    label: contract.label,
    description: contract.description,
    labelRu: contract.labelRu,
