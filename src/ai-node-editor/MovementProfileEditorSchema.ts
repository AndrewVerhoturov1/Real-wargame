...
export const MOVEMENT_EDITOR_GROUPS: readonly MovementEditorGroup[] = [
  ...
  ['Визуальная заметность', 'Только модификаторы движения; профиль внимания остаётся отдельным.', [
    ...
    ['settings.visibility.stealthSkillShare','Доля навыка скрытности','Доля навыка бойца, влияющая на заметность движения.',0,1,.01,'0–1'],
  ...
  ['Оружие', 'Действия с оружием во время и после движения.', [
    ...
    ['settings.weapon.aimPreparationMultiplier','Множитель подготовки прицела','Масштабирует время подготовки и наведения после движения.',.25,4,.05,'×'],
  ...
  ['Ограничения', 'Физическая доступность профиля.', [
    ...
    ['settings.restrictions.maximumSuppressionPercent','Максимальное подавление','Максимальный процент подавления для применения профиля.',0,100,1,'%'],
    ['settings.restrictions.minimumPhysicalCapability','Минимальная физическая способность','Минимальная доля физической способности бойца.',0,1,.01,'0–1'],
  ...
  ['Материалы местности', 'Адаптер канонических профилей поверхности и растительности.', [
    ['settings.surface.materialSpeedMultiplier','Множитель скорости материала','Дополнительный множитель поверх канонического material profile.',0,3,.05,'×'],
    ['settings.surface.materialNoiseMultiplier','Множитель шума материала','Дополнительный множитель шума поверх канонического material profile.',0,3,.05,'×'],
  ]],
];
