 ...
 *
 * The old selected-object/selected-threat geometry was deleted. Directional
 * protection is now calculated only by the shared soldier awareness fields and
 * visualized through field-driven tactical positions.
 */
