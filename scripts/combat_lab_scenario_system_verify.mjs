...
const checks = [
  ...
  ['node', ['scripts/combat_lab_workspace_tabs_contract_smoke.mjs']],
  ['node', ['scripts/combat_lab_workspace_layout_contract_smoke.mjs']],
  ['node', ['scripts/combat_lab_workspace_lifecycle_smoke.mjs']],
