...
const [runtimeSource, visualSource, workspaceSource, compactCss] = await Promise.all([
...
assert.match(compactCss, /unit-bar-speed-group[\s\S]*grid-template-columns:\s*repeat\(7,/);
