...
9. Для Q-режима внешний исполнитель должен вернуть Codex ссылку/номер PR, ветку, список изменённых файлов и статус проверок.
...
4. Уточнить роль: внешний исполнитель, Codex-контролёр, OpenCode-руки или zworker-черновик.
5. Уточнить режим: R, Q или X.
6. Не читать весь репозиторий без необходимости.
7. Работать маленькими ограниченными шагами.
8. В отчёте честно писать, что проверялось и что не проверялось.
