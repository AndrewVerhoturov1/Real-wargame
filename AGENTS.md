...
В системе есть два разных режима внешней работы. Нельзя смешивать их в одном запросе.
...
- `docs/ai/ZWORKER_MODES.md` — различие полного режима R и короткого GitHub-aware режима Q.
