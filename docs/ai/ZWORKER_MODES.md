# Режимы внешней работы: R и Q

Этот документ фиксирует рабочий v1-контур двух режимов внешней работы: полного ручного zworker-режима **R** и короткого GitHub-aware режима **Q**.
...
R сохраняется без ухудшения. Q добавляется как более удобный режим, когда внешний исполнитель действительно умеет работать с GitHub.
