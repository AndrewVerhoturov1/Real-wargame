...
- **2026-07-06**: Added Run-Real-Wargame.bat — one-click Windows launcher for the tactical-board dev server. Handles: port 5173 cleanup, npm verification, auto npm install, separate dev-server window, HTTP-ready wait, and default browser open. ASCII-only .bat file.
