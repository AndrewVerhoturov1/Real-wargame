...
|---|---|---|---|---|---|
| [AI Single-Unit Editor — Stateful Tactical Awareness, Hierarchical States and Plans](ai-single-unit-editor/STATUS.md) | `ai-single-unit-editor` | active | The first State → Utility → Plan → Subgraph vertical slice is implemented and its mandatory automated regression is green. Browser visual QA is prepared and awaits explicit user approval. | After explicit approval, run the prepared system-Chromium visual QA and inspect the five PNGs. Keep the work on the temporary branch until the user separately commands transfer to real-wargame-preview. | 2026-07-14 |
