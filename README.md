...
Ограничение: этот этап ещё не подключает граф к живому `SimulationTick` и не двигает настоящего солдата на карте. `evaluate-once` сейчас честно проверяет структуру универсального графа и возвращает preview-команду только если в графе уже есть нода действия.
